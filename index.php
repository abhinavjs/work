                ...
                <div class="col-lg-6 col-md-6 col-xs-12">
                    <div class="left-text-content">
                        ...
                        <div class="row">
                            ...
                            $select = "SELECT * FROM cafeabouttb";
                            ...
                            while ($fetch = mysqli_fetch_assoc($query)) {
                                ...
                                <div class="col-4">
                                    <img src='admin/about/<?php echo $fetch["image"] ?>' alt="" width="150px"
                                        height="150px">
                                </div>
                        ...
                        <div class="chef-item">
                            <div class="thumb">
                                ...
                                <ul class="social-icons">
                                    <li><a href='<?php echo $fetch["facebook"] ?>'><i class="fa fa-facebook"></i></a></li>
                                    <li><a href='<?php echo $fetch["whatsapp"] ?>'><i class="fa fa-whatsapp"></i></a></li>
                                    <li><a href='<?php echo $fetch["instagram"] ?>'><i class="fa fa-instagram"></i></a></li>
                                </ul>
                                <img src='admin/chef/<?php echo $fetch["image"] ?>' alt="" width="410px" height="410px">
                            </div>
                            <div class="down-content">
                                <h4>
                                    <?php echo $fetch["chefname"] ?>
                                </h4>
                                <span>
                                    <?php echo $fetch["skill"] ?>
                                </span>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="contact-form">
                        ...
                        <form id="contact" action="PHPMail3/PHPMail3/mail.php" method="POST">
                            <div class="row">
                                <div class="col-lg-12">
                                ...
                                <div class="col-lg-6 col-sm-12">
                                    <fieldset>
                                        <input name="customername" type="text" id="name" placeholder="Your Name*"
                                            required="">
                                    </fieldset>
                                </div>
                                <div class="col-lg-6 col-sm-12">
                                ...
                                <article id='tabs-1'>
                                    <div class="row">
                                     ...
                                     require_once ("admin/connection.php");
                                      ...
                                      $select = "SELECT * FROM cafebreaktb";
                                      ...
                                      while ($fetch = mysqli_fetch_assoc($query)) {
                                         ...
                                         ?>
                                                <div class="left-list">
                                                    <div class="col-lg-12">
                                                        <div class="tab-item">
                                                            <img src='admin/breakfast1/<?php echo $fetch ["image"]?>' width="120px" height="100px" alt="">
                                                            <h4><?php echo $fetch["food"]?></h4>
                                                            <p><?php echo $fetch["aboutfood"]?></p>
                                                            <div class="price">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            $select = "SELECT * FROM cafebreak2tb";
                                         ...
                                         ?>
                                                <div class="right-list">
                                                    <div class="col-lg-12">
                                                        <div class="tab-item">
                                                            <img src='admin/breakfast2/<?php echo $fetch ["image"]?>' width="130px" height="100px" alt="">
                                                            <h4><?php echo $fetch ["food"]?></h4>
                                                            <p><?php echo $fetch["aboutfood"]?></p>
                                                            <div class="price">
                                                                <h6>$<?php echo $fetch["price"]?></h6>
                                ...
                                <article id='tabs-2'>
                                    <div class="row">
                                        <div class="col-lg-6">
                                            ...
                                            $select = "SELECT * FROM cafelunch1tb";
                                         ...
                                         ?>
                                                <div class="left-list">
                                                    <div class="col-lg-12">
                                                        <div class="tab-item">
                                                        <img src='admin/lunch1/<?php echo $fetch ["image"]?>' width="130px" height="100px" alt="">
                                                            <h4><?php echo $fetch ["food"]?></h4>
                                                            <p><?php echo $fetch["aboutfood"]?></p>
                                                            <div class="price">
                                                                <h6>$<?php echo $fetch["price"]?></h6>
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            $select = "SELECT * FROM cafelunch2tb";
                                         ...
                                         ?>
                                                <div class="right-list">
                                                    <div class="col-lg-12">
                                                        <div class="tab-item">
                                                        <img src='admin/lunch2/<?php echo $fetch ["image"]?>' width="130px" height="100px" alt="">
                                                            <h4><?php echo $fetch ["food"]?></h4>
                                                            <p><?php echo $fetch["aboutfood"]?></p>
                                                            <div class="price">
                                                                <h6>$<?php echo $fetch["price"]?></h6>
                                ...
                                <article id='tabs-3'>
                                    <div class="row">
                                        <div class="col-lg-6">
                                            ...
                                            $select = "SELECT * FROM cafedinner1tb";
                                         ...
                                         ?>
                                                <div class="left-list">
                                                    <div class="col-lg-12">
                                                        <div class="tab-item">
                                                        <img src='admin/dinner1/<?php echo $fetch ["image"]?>' width="130px" height="100px" alt="">
                                                            <h4><?php echo $fetch ["food"]?></h4>
                                                            <p><?php echo $fetch["aboutfood"]?></p>
                                                            <div class="price">
                                                                <h6>$<?php echo $fetch["price"]?></h6>
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            $select = "SELECT * FROM cafedinner2tb";
                                         ...
                                         ?>
                                                <div class="right-list">
                                                    <div class="col-lg-12">
                                                        <div class="tab-item">
                                                        <img src='admin/dinner2/<?php echo $fetch ["image"]?>' width="130px" height="100px" alt="">
                                                            <h4><?php echo $fetch ["food"]?></h4>
                                                            <p><?php echo $fetch["aboutfood"]?></p>
                                                            <div class="price">
                                                                <h6>$<?php echo $fetch["price"]?></h6>
